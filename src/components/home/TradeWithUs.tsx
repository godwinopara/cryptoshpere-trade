		...
		<section className="px-4 lg:grid grid-cols-2 max-w-desktop mx-auto gap-28 py-24">
			<div className="mb-20 lg:mb-0">
				<div className="mb-10">
					...
					<br />
					<p>
						Our powerful API technology lets you integrate your strategy with trading applications
						or build your own custom user interfaces. You can also create and test your own
