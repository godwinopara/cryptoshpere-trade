...
// 	title: "Login | Universal Cryptosphere Trade",
// 	description: "This is Login page for Universal Cryptosphere Trade",
// 	// other metadata
// };
...
const Login = () => {
	return (
		<>
			<div className="mt-10 max-w-292.5 mx-auto rounded-sm  bg-white shadow-default">
