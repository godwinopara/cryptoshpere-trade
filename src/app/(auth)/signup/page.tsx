...
import authImg from "public/images/auth-screens.png";
import { useEffect, useState } from "react";

// export const metadata: Metadata = {
// 	title: "Sign Up | Universal Cryptosphere Trade",
// 	description: "This is Sign Up page for Universal Cryptosphere Trade",
// 	// other metadata
// };
...
const Login = () => {
	...
	useEffect(() => {
		const getCountries = async () => {
			try {
				...
				const data: AxiosResponse<Country[]> = res.data;
	...
	return (
		<>
			<div className="max-w-desktop mx-auto rounded-sm  bg-white shadow-default">
